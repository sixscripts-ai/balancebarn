...
export function calculate_all_core_metrics(transactions: Transaction[]) {
    const metrics = [];
...
export function calculate_advanced_algorithms(transactions: Transaction[], basicMetrics: any) {
    const algorithms = [];
