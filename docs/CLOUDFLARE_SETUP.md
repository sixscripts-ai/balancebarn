...
2. Cloudflare Email Routing enabled for your zone (thebalancebarn.com)
...
Make sure Email Routing for your domain (thebalancebarn.com) is set up and you have a destination address. The site sends emails to: support@thebalancebarn.com
...
**Emails not sending?**
- Ensure Email Routing is enabled for thebalancebarn.com
